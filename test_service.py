...
import service.service_spec.reading_files_pb2_grpc as grpc_ex_grpc
import service.service_spec.reading_files_pb2 as grpc_ex_pb2
...
if __name__ == "__main__":
    ...
    try:
        ...
        endpoint = input("Endpoint (localhost:{}): ".format(registry["server"]["grpc"])) if not test_flag else ""
        if endpoint == "":
            endpoint = "localhost:{}".format(registry["server"]["grpc"])
